...
Sentence.create(id: 40, challenge_id: 100, grammar_point: "presente", eng_grammar_point: "simple present tense", user_sent: "Él habla español y francés con fluidez.", ai_sent: "Él habla español y francés con fluidez.")
Sentence.create(id: 41, challenge_id: 100, grammar_point: "pretérito indefinido", eng_grammar_point: "simple past tense", user_sent: "Mi dos hijos estaban hablo francés al revisor de tren.", ai_sent: "Mis dos hijos estaban hablando francés al revisor del tren.")
...
Sentence.create(id: 42, challenge_id: 101, grammar_point: "presente", eng_grammar_point: "simple present tense", user_sent: "Me gusta comer sushi de vez en cuando.", ai_sent: "Me gusta comer sushi de vez en cuando.")
Sentence.create(id: 43, challenge_id: 101, grammar_point: "futuro", eng_grammar_point: "simple future tense", user_sent: "Mis hijos no comer platos de fideos.", ai_sent: "Mis hijos no comerán platos de fideos.")

Challenge.create(id: 102, user_id: 1, language: "Spanish", verb: "necesitar", eng_verb: "to need", image_url: "https://images.unsplash.com/photo-1682253572700-4173885b68f2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80", image_alt_text: "playing guitar")
Sentence.create(id: 44, challenge_id: 102, grammar_point: "futuro", eng_grammar_point: "simple future tense", user_sent: "El hombre necesitará más práctica si quiere ser un buen guitarrista.", ai_sent: "El hombre necesitará más práctica si quiere ser un buen guitarrista.")
Sentence.create(id: 45, challenge_id: 102, grammar_point: "subjuntivo pasado", eng_grammar_point: "past subjunctive", user_sent: "Si yo hubiera necesitar ayuda, habría buscado a un profesor de guitarra que me enseñara.", ai_sent: "Si yo hubiera necesitado ayuda, habría buscado a un profesor de guitarra que me enseñara.")

Challenge.create(id: 103, user_id: 1, language: "Spanish", verb: "retrasar", eng_verb: "to postpone", image_url: "https://images.unsplash.com/photo-1683567935687-2e22ca8c9805?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1767&q=80", image_alt_text: "walking at dusk in the mountains")
...
Sentence.create(id: 47, challenge_id: 103, grammar_point: "pretérito indefinido", eng_grammar_point: "simple past tense", user_sent: "Retrasa su cena y disfrutó del paisaje.", ai_sent: "Retrasó su cena y disfrutó del paisaje.")
...
#### Challenges & Sentences ####
Challenge.create(id: 50, user_id: 55, language: "Turkish", verb: "(e/a) gitmek", eng_verb: "to go", image_url: "https://images.unsplash.com/photo-1500835556837-99ac94a94552?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80", image_alt_text: "Plane flying")
Sentence.create(id: 10, challenge_id: 50, grammar_point: "gelecek zaman (-ecek)", eng_grammar_point: "future tense", user_sent: "Yarın annem beni havalimanına bırakmak için araba kullanacak.", ai_sent: "Yarın annem beni havalimanına bırakmak için araba kullanacak.")
Sentence.create(id: 11, challenge_id: 50, grammar_point: "olumsuz geçmiş zaman (-me/-ma + di/-tı)", eng_grammar_point: "negative past tense", user_sent: "Dün havalimana gittik ama arkadaşım uçak gelmedi.", ai_sent: "Dün havalimanına gittik, ancak arkadaşımızın uçağı gelmedi.")

Challenge.create(id: 51, user_id: 55, language: "Turkish", verb: "(i) bilmek", eng_verb: "to know", image_url: "https://plus.unsplash.com/premium_photo-1674831140622-93f54b70bfbf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80", image_alt_text: "Elephant")
...
Sentence.create(id: 16, challenge_id: 53, grammar_point: "olumlu geçmiş zaman (-di/-tı)", eng_grammar_point: "positive past tense", user_sent: "Yakamozdan etkilendim", ai_sent: "Yakamozdan etkilendim")
Sentence.create(id: 17, challenge_id: 53, grammar_point: "ulaçlar sebep (-me/-ma + kişi için)", eng_grammar_point: "because", user_sent: "Denizin güzelliğiden etkilendiği için ay ışığına dans etti.", ai_sent: "Denizin güzelliğinden etkilendiği için ay ışığında dans etti.")
