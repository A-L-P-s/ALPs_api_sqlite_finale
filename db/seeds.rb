...
GrammarPoint.create(language: "Vietnamese", grammar_point: "hiếm khi", eng_grammar_point: "Adverbs of Time and Frequency")
GrammarPoint.create(language: "Vietnamese", grammar_point: "ở đâu", eng_grammar_point: "Adverbs of Place")
GrammarPoint.create(language: "Vietnamese", grammar_point: "của", eng_grammar_point: "Possession")
GrammarPoint.create(language: "Vietnamese", grammar_point: "rất", eng_grammar_point: "Adjective Intensifiers")
GrammarPoint.create(language: "Vietnamese", grammar_point: "đã", eng_grammar_point: "past tense")
GrammarPoint.create(language: "Vietnamese", grammar_point: "sẽ", eng_grammar_point: "future tense")
GrammarPoint.create(language: "Vietnamese", grammar_point: "đang", eng_grammar_point: "present tense")
GrammarPoint.create(language: "Vietnamese", grammar_point: "bởi vì", eng_grammar_point: "because")
GrammarPoint.create(language: "Vietnamese", grammar_point: "nếu", eng_grammar_point: "conditional")
