...
Challenge.create(id: 52, user_id: 1, language: "Turkish", verb: "(e/a) aldırmak", eng_verb: "to pay attention/to ignore",
...
Sentence.create(id: 14, challenge_id: 52, grammar_point: "ulaçlar amaç (-mek için)", eng_grammar_point: "in order to", user_sent: "Bugünün dersine aldırmak için üç kahve içmeliyim.",
                ai_sent: "Bugünün dersine aldırmak için üç kahve içmeliyim.")
